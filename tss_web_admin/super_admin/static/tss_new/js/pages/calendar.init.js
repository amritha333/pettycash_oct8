document.addEventListener("DOMContentLoaded", function () {
    ...
    var c = [{
        ...
        m = (document.getElementById("external-events"), document.getElementById("calendar"));

    function u(e) {
        l.show(), n.classList.remove("was-validated"), n.reset(), d = null, t.innerText = "Add Event", i = e
    }
    ...
    var g = new FullCalendar.Calendar(m, {
        ...
        eventClick: function (e) {
            l.show(), n.reset(), document.getElementById("event-title").value[0] = "", d = e.event, document.getElementById("event-title").value = d.title, document.getElementById("event-category").value = d.classNames[0], i = null, t.innerText = "Edit Event", i = null
        },
    ...
    g.render(), n.addEventListener("submit", function (e) {
        e.preventDefault();
        var t, n = document.getElementById("event-title").value,
            a = document.getElementById("event-category").value;
        !1 === r[0].checkValidity() ? r[0].classList.add("was-validated") : (d ? (d.setProp("title", n), d.setProp("classNames", [a])) : (t = {
            title: n,
            start: i.date,
            allDay: i.allDay,
            className: a
