! function (t, e) {
    ...
    function E(t, e, n, r, i, o, s, a, u, l) {
        ...
        for (n.__k = [], c = 0; c < e.length; c++)
            if (null != (f = n.__k[c] = null == (f = e[c]) || "boolean" == typeof f ? null : "string" == typeof f || "number" == typeof f || "bigint" == typeof f ? w(null, f, null, null, f) : Array.isArray(f) ? w(P, {
                    children: f
        ...
        if (v)
            for (c = 0; c < v.length; c++) H(v[c], v[++c], v[++c])
    }
    ...
    function R(t, e, n, r, i) {
        ...
        else if ("o" === e[0] && "n" === e[1]) o = e !== (e = e.replace(/Capture$/, "")), e = e.toLowerCase() in t ? e.toLowerCase().slice(2) : e.slice(2), t.l || (t.l = {}), t.l[e + o] = n, n ? r || t.addEventListener(e, o ? A : L, o) : t.removeEventListener(e, o ? A : L, o);
    ...
    function I(t, e, n, r, i, o, s, a, u) {
        ...
        try {
            t: if ("function" == typeof N) {
                if (w = e.props, S = (c = N.contextType) && r[c.__c], C = c ? S ? S.props.value : c.__ : r, n.__c ? b = (p = e.__c = n.__c).__ = p.__E : ("prototype" in N && N.prototype.render ? e.__c = p = new N(w, C) : (e.__c = p = new k(w, C), p.constructor = N, p.render = O), S && S.sub(p), p.props = w, p.state || (p.state = {}), p.context = C, p.__n = r, h = p.__d = !0, p.__h = []), null == p.__s && (p.__s = p.state), null != N.getDerivedStateFromProps && (p.__s == p.state && (p.__s = v({}, p.__s)), v(p.__s, N.getDerivedStateFromProps(w, p.__s))), f = p.props, d = p.state, h) null == N.getDerivedStateFromProps && null != p.componentWillMount && p.componentWillMount(), null != p.componentDidMount && p.__h.push(p.componentDidMount);
                else {
                ...
                var u, l, c, p, h = n.props,
                    f = e.props,
                    d = e.type,
                    g = 0;
                if ("svg" === d && (i = !0), null != o)
                    for (; g < o.length; g++)
                        if ((u = o[g]) && (u === t || (d ? u.localName == d : 3 == u.nodeType))) {
                            t = u, o[g] = null;
                            break
                        } if (null == t) {
                ...
                if (null === d) h === f || a && t.data === f || (t.data = f);
                    ...
                    if (o = o && m.slice.call(t.childNodes), l = (h = n.props || _).dangerouslySetInnerHTML, c = f.dangerouslySetInnerHTML, !a) {
                        if (null != o)
                            for (h = {}, p = 0; p < t.attributes.length; p++) h[t.attributes[p].name] = t.attributes[p].value;
                    ...
                    else if (g = e.props.children, E(t, Array.isArray(g) ? g : [g], e, n, r, i && "foreignObject" !== d, o, s, t.firstChild, a), null != o)
                        for (g = o.length; g--;) null != o[g] && y(o[g]);
    ...
    function M(t, e, n) {
        ...
        if (r = t.__k)
            for (o = 0; o < r.length; o++) r[o] && M(r[o], e, n);
        null != i && y(i)
    }
    ...
    var yt = function (t) {
        ...
        return n.widths = function () {
            ...
            var t = Array.from(this.base.parentNode.querySelectorAll("thead th")).reduce(function (t, e) {
                var n;
                return e.style.width = e.clientWidth + "px", r(((n = {})[e.getAttribute("data-column-id")] = {
            ...
            return s.adjustWidth = function (t) {
                ...
                for (var n, i = u(e || this.columns || []); !(n = i()).done;) {
                    ...
                    o.columns && o.columns.length > 0 && (o.sort = {
                        ...
                        enabled: !0
                    }), o.sort ? "object" == typeof o.sort && (o.sort = r({
                        enabled: !0
                    }, o.sort)) : o.sort = {
                        enabled: !1
                ...
                for (var e, n = new o, r = u(t); !(e = r()).done;) {
                    var i = e.value;
                    if ("string" == typeof i || c(i)) n.columns.push({
                        name: i
                    });
    ...
    var Dt, Rt = function (t) {
        ...
        Ht = function () {
            ...
            return t.createFromConfig = function (t) {
                var e = new Rt;
                return t.storage instanceof Ct && e.register(new It({
        ...
        Mt = function () {
            ...
            return n.assign = function (t) {
                ...
                var i = new e(n);
                return i._userConfig = n, "boolean" == typeof n.sort && n.sort && i.assign({
                    sort: {
                        multiColumn: !0
                    }
                }), i.assign({
                    header: wt.fromUserConfig(i)
                }), i.assign({
                    storage: xt.createFromUserConfig(n)
                }), i.assign({
                    pipeline: Ht.createFromConfig(i)
                }), i.assign({
                    translator: new q(n.language)
                }), i.plugin.add({
                    id: "search",
    ...
    var Ot, jt, Wt, Bt = function (t) {
        ...
        Yt = function (t) {
            ...
            return n.componentWillUnmount = function () {
                ...
                return n.length > 0 ? e = n[0] : (this.updateSortProcessorFn = this.updateSortProcessor.bind(this), this.store.on("updated", this.updateSortProcessorFn), e = t === K.ServerSort ? new Vt(r({
        ...
        Jt = function (t) {
            ...
            return n.isSortable = function () {
                ...
                }, this.content()), this.isSortable() && b(Yt, r({
                    ref: this.sortRef,
        ...
        te = function (t) {
            ...
            return i(e, t), e.prototype.render = function () {
                return b("table", {
                    ...
                    style: r({}, this.config.style.table, {
        ...
        ee = function (e) {
            function n(t, n) {
                var r;
                return (r = e.call(this, t, n) || this).headerRef = {
                    current: null
                }, r.state = {
                    isActive: !0
                }, r
        ...
        ne = function (e) {
            function n(t, n) {
                var r;
                return (r = e.call(this, t, n) || this).footerRef = {
                    current: null
                }, r.state = {
                    isActive: !0
                }, r
        ...
        re = function (t) {
            ...
            return n.processPipeline = function () {
                ...
                return b(this.configContext.Provider, {
                    ...
                    style: r({}, this.props.config.style.container, {
                        width: this.props.width
                    })
                }, this.state.status === Dt.Loading && b("div", {
